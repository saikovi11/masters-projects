...
class GoBackNInterface extends JFrame {
	...
	public GoBackNInterface(){
		super("Go-Back-N Error Control Protocol");
		setLayout(null);
		    	...
		    	if (serverPort.getText().equals("") || packetLosses.getText().equals("")){
		    		...
		    		try {
			    		...
			    		if (port < 1024 || port > 49151){
				    		...
				    		Sender sender = new Sender(address,port,lossesP,serverButton.isSelected());
